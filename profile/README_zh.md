<div align="center">
  <a href="https://videoweb.ai/cn/"><img src="https://raw.githubusercontent.com/aivideoweb/.github/main/profile/assets/videoweb-logo.svg" alt="VideoWeb AI 品牌标识" width="160" height="160"></a>

# VideoWeb AI

**把想法变成视频、图片和音乐。从一个免费工具、一段清楚的创作描述开始。**

[![进入创作工作区](https://img.shields.io/badge/%E8%BF%9B%E5%85%A5%E5%88%9B%E4%BD%9C%E5%B7%A5%E4%BD%9C%E5%8C%BA-647A30?style=for-the-badge)](https://videoweb.ai/cn/create/)
...
[VideoWeb AI](https://videoweb.ai/cn/) 把 AI 视频生成、图片创作与编辑、音乐工具放在同一个浏览器工作区，面向内容创作者、营销人员、电商团队和教师。输入一段场景描述，或上传产品照片、分镜图片，再选择模型开始创作，不需要编写代码。
...
| 工具 | 能得到什么 |
| --- | --- |
| [视频提示词生成器](https://videoweb.ai/cn/ai-video-prompt-generator/) | 把简单的想法展开成更具体的视频提示词 |
| [图片转提示词](https://videoweb.ai/cn/ai-image-to-prompt/) | 将图片中可见的特点整理为文字提示词 |
| [背景移除工具](https://videoweb.ai/cn/ai-remove-background/) | 提取主体，得到可用于排版的透明背景图片 |
| [图片描述工具](https://videoweb.ai/cn/describe-image/) | 图片描述、配文，或针对图片提问的回答 |
| [MP4 转 MOV](https://videoweb.ai/cn/mp4-to-mov/) · [MP4 转 AVI](https://videoweb.ai/cn/mp4-to-avi/) | 转换视频文件格式；两种表单均标明单次上传**最长 60 秒、最大 50 MB** |

**免费范围怎么理解：**独立免费生成器与账号的免费套餐是不同入口。免费表单可能需要验证和排队。[价格页](https://videoweb.ai/cn/pricing/)另列出免费账号的新用户 40 积分、每日签到 20 积分及每天 50 次免费工具使用额度，不能将该账号额度套用到所有独立免费页面。高级模型生成有各自的积分费用和参数，请在提交前查看所选表单。存在免费入口，不代表所有模型、分辨率和导出选项都免费。
...
可以从[免费 H3 指南中的温馨房间练习](https://github.com/aivideoweb/best-free-minimax-h3/blob/main/docs/free-tool-prompts.md#user-content-videoweb)开始。源文提供英文和中文，下方是简体中文译例，无需再去提示词库查找即可练习。这是纯文字练习，不是已经生成的视频。

1. 打开[免费 MiniMax H3](https://videoweb.ai/cn/free-minimax-h3/)，将两个图片位置留空。
2. 粘贴下方提示词，选择横屏 **16:9**。免费输出为 5 秒、480p。
3. 完成页面要求的验证，提交一次并关注任务状态。返回视频后，先预览再下载。
4. 检查门框是否保持笔直、镜头运动是否平滑，以及结尾是否完整呈现椅子和灯。如果运动不连贯，下次就缩短镜头移动距离。

```text
生成一个五秒的连续镜头，画面比例为 16:9。
镜头起初静止在一扇敞开的木门外，然后缓慢向前推进，进入安静的阅读室。
窗边的窗帘轻轻摆动。结尾完整呈现椅子和灯。
保持门框笔直，房间布局不变。轻柔的室内环境声，没有对话或文字。
最后一秒保持平稳。不要切镜，也不要增加场景切换。
```

**改成你的场景：**先把“阅读室”换成你想拍的地方，例如一家小店，再把“椅子和灯”换成你希望在结尾呈现的物品。保留连续镜头、缓慢推进和平稳的最后一秒。每次只改一项要求，然后重新检查相同细节。

这项练习尚未经过生成实测。它用于生成文字描述的场景，单靠文字无法保留真实房间或产品的外观。若要用图片引导，需在免费表单中同时提供首帧和尾帧。需要更长的场景或其他输出设置时，可打开 [H3 模型页](https://videoweb.ai/cn/model/minimax-h3/)，查看选项和积分费用。

**还需要配乐？**打开 [AI 音乐生成器](https://videoweb.ai/cn/ai-music/)，选择可用模型和 Instrumental（纯音乐）模式，试着描述：“温暖的木吉他与轻柔打击乐，轻松的情绪，稳定的节奏，无人声，用于安静的产品演示。”生成前检查积分费用，再将音乐与视频对照试听。这段音乐提示词尚未生成验证。音乐创作是独立流程，最终配乐需要在后续剪辑时加入。
...
第一次练习可以用上方链接的温馨房间示例，了解该复制什么、怎么改、检查哪些细节。使用其他提示词时，请按要求准备参考文件，并确认生成器是否支持相应要求。需要视频参考或更长时长的提示词，应先改写，才能用于五秒免费表单。[浏览 VideoWeb 全部仓库](https://github.com/orgs/aivideoweb/repositories)。

## 分享教程，与 VideoWeb 开展推广合作

[VideoWeb 推广合作计划](https://videoweb.ai/cn/affiliate-program/)面向分享实用教程和创作流程的视频作者、工具评测者、营销人员和教师。
...
1. 打开[合作计划页面](https://videoweb.ai/cn/affiliate-program/)，登录 VideoWeb 账号。
2. 填写推广伙伴资料与收款信息，阅读并接受[推广合作协议](https://videoweb.ai/cn/affiliate-agreement/)。
...
- **开始创作：**进入[创作工作区](https://videoweb.ai/cn/create/)，或选择上面的免费工具。
...
产品信息依据链接页面核对，日期为 **2026 年 9 月 22 日**。模型能力与免费条件来自页面说明，本介绍没有进行生成实测。商用前请查看所用套餐与[服务条款](https://videoweb.ai/cn/terms-of-service/)。

<div align="center">

**准备好创作了吗？选一个入口，开始你的第一份作品。**

[![免费制作短片](https://img.shields.io/badge/%E5%85%8D%E8%B4%B9%E5%88%B6%E4%BD%9C%E7%9F%AD%E7%89%87-6D4AFF?style=for-the-badge)](https://videoweb.ai/cn/free-minimax-h3/) [![免费制作图片](https://img.shields.io/badge/%E5%85%8D%E8%B4%B9%E5%88%B6%E4%BD%9C%E5%9B%BE%E7%89%87-147D92?style=for-the-badge)](https://videoweb.ai/cn/free-gpt-image-2-5/)

[VideoWeb AI](https://videoweb.ai/cn/) · [开源项目](https://github.com/aivideoweb)
